...
<div class="wrapper">
        ...
        <div id="content">
            <h1>Update Time</h1>
        <form action="<?php echo base_url('index.php/dashboard/updateclockintime/'.$id->id ) ?>" method="post" class="updatetime">
                    <div class="form-group">
                    <input type="text" id="form3Example3cg" name="clockin" value="<?= $id->clockin ?>" class="form-control form-control-lg"/>
                    </div>
                    <div class="row">
